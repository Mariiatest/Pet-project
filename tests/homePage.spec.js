...
test.only('User is able to go to confirming modal', async ({ page }) => {
 ...
 const iframeContainer = page.frameLocator('iframe[name="22e259f8-0f45-4885-a6eb-682d0e746513"]');
...
test ('User is able to search', async ({ page }) => {
  ...
  await expect (page).toHaveURL('/**/mobile-phones/c80003/producer=apple/#search_text=iphone')
